  ...
  return (
    <Section>
      <div className="relative bg-cover h-96" style={{ backgroundImage: `url('${imagem}')` }}>
        <div className="absolute inset-0 flex flex-col gap-3 justify-center items-start p-12 text-white text-center">
          {imagem && <img src="/flags/br.svg" alt={titulo} className="w-12 h-8" />}
